...
\citet{fold_graciously} \marginpar{Levinthal's paradox}
...
\begin{align*}
H(\left\{r\right\}_{i=0}^N) =& \underbrace{\sum_{bonds} k_b \left(d - d_0\right)^2}_\alpha + 
...
In practice, this is not a significant problem because we can set them to the ideal values, and the perturbations are typically small.
