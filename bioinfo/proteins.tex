...
The differences between most of them are only on the side chain\footnote{The amino acid proline's sidechain has a ring connecting with the amine in the backbone.}.
...
In the last decades a new method has become practical for protein structures: cryogenic electron microscopy \marginpar{cryo-EM}.
...
The first is Small Angle X-ray Scatering, or SAXS. \marginpar{SAXS}
