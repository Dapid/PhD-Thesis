...
We went from measuring the variables present in our equations, to representing the world in numbers on a computer.
...
\begin{figure}[p] %[p]age of floats
	\centering
	...
	\includegraphics[trim={20mm, 29mm, -10mm, 11mm}, clip, width=1.4\textwidth, center]{machine_learning/figures/tree} %
	\caption{The rules of a decision tree are interpretable.
	The darkness of the background corresponds to the purity of the node.
...
The results of machine learning can be impressive and lead to think too much of them.
Machine learning models are incapable of reasoning, and they are blindly extracting a signal from the training data.
