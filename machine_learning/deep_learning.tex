...
With transfer learning we can learn a high quality representation on a related task for which we have a suitable dataset, and transfer it to our model of interest.
\todo{finish}

Paper \textcolor{Maroon}{IV}
