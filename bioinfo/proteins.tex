...
Typically, the fully folded state is reached in the order of milliseconds to seconds. \longsidenote{The most infamous case is the mad cows disease.}
The hypothesis has a few exceptions, namely: fibrous proteins, prions  -- which are proteins that have an alternative but non-functional stable tertiary structure 
 --  aggregating proteins \longsidenote{Both Alzheimer and Multiple Sclerosis are caused by aggregating proteins.} -- where the individual proteins bind to each other forming large and non-functional structures -- and large, multi-domain proteins.
