...
Indeed, neural networks are very good at \emph{perceptual learning}, or tasks where the computer replaces the senses.
...
It works as a layer that keeps \todo{batchnorm}
