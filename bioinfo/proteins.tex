...
Proteins are the fundamental machines in biology, performing tasks such as catalysis, transporting molecules, and providing the structural backbone of the cell.
...
This new molecule is then transported to the ribosome, the organelle\todo{not an organelle} that translates the RNA into functional proteins.
...
There are at least 500 known naturally occurring amino acids \citep{500_amino_acids}, of which only twenty different species are usually codified in the DNA.\todo{simplify, move 500 away}
...
Having a common backbone means that in principle, any amino acid can be connected to any other, which gives proteins a very rich and flexible biochemistry:\todo{wrong word}
...
The collection of all protein sequences of an organism is the \emph{proteome}.\todo{Experiment gives DNA->protein translated}


\subsection{Secondary structure}
The polypeptide chains are locally organised in motifs stabilised by hydrogen bonds.\todo{justify}
...
Once the chain is locally stabilised by the hydrogen bonds it needs\todo{needs wrong word} to fold into a compact structure.
...
Experiments show that proteins placed in the right medium of pH and temperature will unfold into a random coil, with no trace of tertiary nor secondary structure.\todo{Mover reference up here, as not all follow this}
...
\begin{itemize}
	...
	\SI{10-15}{kcal/mol}\todo{not very strong}
...
The alternative method is Nuclear Magnetic Resonance (NMR), \marginpar{NMR} which applies strong oscillating magnetic fields and measures resonances.
...
Mass-spectrometry cross-linking \marginpar{Cross-linking} can be used to measure distances within proteins.
