...
One procedure implemented by \citet{tf_privacy} starts by splitting the minibatch into microbatches, and computing the gradient for each of them.
...
A similar idea is applied in recurrent networks LSTM 
