...
In other words, without inputting domain knowledge that restricts the space of possibilities, we cannot do better than random. \todo{elaborate}
...
\todo{sidetrack: parameters and hyperparameters}
